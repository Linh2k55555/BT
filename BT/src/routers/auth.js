...
import { signup, signin, logout, updatePassword, renderUpdateInfo, updateUserInfo} from "../controllers/auth.js";
...
router.get("/update-user", isAuthenticated, renderUpdateInfo); // Trang đổi thông tin
